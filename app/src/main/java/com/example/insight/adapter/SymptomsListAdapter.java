...
public class SymptomsListAdapter extends RecyclerView.Adapter<SymptomsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SymptomsViewHolder holder, int position) {
        ...
        String dateTimeStr = DateValidator.LocalDateToString(item.getRecordDate()) +" ("+ TimeValidator.LocalTimeToString(item.getStartTime())+" - "+ TimeValidator.LocalTimeToString(item.getEndTime())+")"; // 10-10-2025 (13:30)
        String valueStr = item.getSymptomLevel();
